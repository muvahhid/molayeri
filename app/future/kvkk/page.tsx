...
import { FUTURE_KVKK_TEXT, FUTURE_KVKK_VERSION } from '@/lib/future-legal-documents'

export default function FutureKvkkPage() {
  return (
    <main className="min-h-screen bg-[#050811] text-white">
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 rounded-[22px] border border-white/12 bg-white/[0.03] p-5 sm:p-7 backdrop-blur-xl">
          <h1 className="text-2xl font-black tracking-tight sm:text-3xl">KVKK Aydınlatma Metni ve Gizlilik Politikası</h1>
          <p className="mt-2 text-xs font-semibold tracking-wide text-white/60">Versiyon: {FUTURE_KVKK_VERSION}</p>
